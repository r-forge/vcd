...
\title{The Strucplot Framework:\\ Visualizing Multi-way Contingency
  Tables with \pkg{vcd}}
\author{David Meyer \hspace{2cm} Achim Zeileis \hspace{2cm} Kurt Hornik\\
  Wirtschaftsuniversit\"at Wien}
\Plainauthor{David Meyer, Achim Zeileis, Kurt Hornik}
\Plaintitle{The Strucplot Framework: Visualizing Multi-way Contingency Tables with vcd}
...
residual-based shading, \pkg{grid}, \textsf{R}}
\Plainkeywords{contingency tables, mosaic plots, association plots, sieve plots, 
categorical data, independence, conditional independence, HSV, HCL,
residual-based shading, grid, R}
...
\fronttitle{The Strucplot Framework: Visualizing Multi-way Contingency
  Tables with vcd}
\frontauthor{David Meyer, Achim Zeileis, Kurt Hornik}
\frontnumber{22}
\frontdate{November 2005}
\frontpage
