...
data(Employment)
emp <- Employment
emp1 <- co.table(Employment, "LayoffCause")[["Replaced"]]
@
...
grid.mosaicplot(emp1, gp = gp.Friendly)
@
<<emp1-max,fig=TRUE,echo=FALSE,height=6,width=7,results=hide>>=
grid.mosaicplot(emp1, gp = gp.max)
@
