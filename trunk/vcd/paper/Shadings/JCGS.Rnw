...
in two directions: (a)~perceptually uniform Hue-Chroma-Luminance colors are used and (b)~the
...
independence model. It shows an association between memories and attitude
