...
\begin{figure}[t!]
\begin{center}
<<conditional_mosaic2,fig=TRUE,echo=FALSE,height=11,width=11>>=
...
A vignette that demonstrates how all empirical examples can exactly be reproduced by the reader
