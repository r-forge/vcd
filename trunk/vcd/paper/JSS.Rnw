...
\item[PreSex]  Data from \cite{vcd:thornes+collard:1979} reported in 
  \cite{vcd:gilbert:1981}, on pre- and extra-marital sex and divorce. Available
  in the \pkg{vcd} package.
\item[Titanic] Information on the fate of passengers on
  ...
  in their investigation of the sinking). Available in base \proglang{R}.
