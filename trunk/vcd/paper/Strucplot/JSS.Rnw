...
\begin{figure}[htbp]
\begin{center}
<<haireyefig1,fig=TRUE,echo=FALSE,height=3,width=5>>=
mosaic(haireye, gp = shading_hsv, margin = c(bottom = 1), keep_aspect_ratio = FALSE)
@
<<haireyefig2,fig=TRUE,echo=FALSE,height=3,width=5>>=
mosaic(haireye, gp = shading_hcl, margin = c(bottom = 1), keep_aspect_ratio = FALSE)
@
<<haireyefig3,fig=TRUE,echo=FALSE,height=3,width=5>>=
...
\begin{figure}[p]
\begin{center}
<<label1fig,fig=TRUE,echo=FALSE,height=10,width=8>>=
...
popViewport(3)
@
\caption{Labeling the Titanic data mosaic. Top left: default labeling, top
