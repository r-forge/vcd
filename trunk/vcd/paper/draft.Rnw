...
residuals {\em individually} significant at approximately the 5\% and 0.01\%
level. But the main purpose of the shading is not to visualize significance but the pattern of
