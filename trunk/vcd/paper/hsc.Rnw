...
residual-based shading added to the mosaic plot.
...
the approval rate decreases with education. As for the question whether
...
column and, to a lesser degree, in the age 40+ row. Moreover, this association is
