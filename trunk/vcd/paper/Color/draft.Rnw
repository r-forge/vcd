...
\author{Achim Zeileis \textnormal{and} Kurt Hornik\\Wirtschaftsuniversit\"at Wien}
...
exception is the \pkg{ColorBrewer.org} tool \citep{vcd:Harrower+Brewer:2003},
...
the SPD performed better in the North and the CDU better in the South; furthermore,
