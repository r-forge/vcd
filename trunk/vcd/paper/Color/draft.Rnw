...
%%FIXME: what to say about ColorBrewer
...
\begin{enumerate}
  ...
  \item \textbf{luminance} (brightness, amount of light)
\end{enumerate}
...
%%FIXME: briefly explain interface
...
%% Paul Murrell, Ross Ihaka, Brian D. Ripley, David Meyer, Thomas Kneib, Michael Hoehle
