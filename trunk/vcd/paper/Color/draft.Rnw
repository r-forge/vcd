...
if(generate_png) {
  ...
  par(mfrow = c(1, 2))
  hue.slice(260, grid.n = 301, main = "H = 260")
  ...
  hue.slice(120, grid.n = 301, main = "H = 120")
...
plane is show for two hues $H = 260$ (left) and $H = 120$ (right). Colors are chosen by varying
