...
class(labeling_list) <- "vcdLabeling"
...
class(labeling_conditional) <- "vcdLabeling"
...
class(labeling_cells) <- "vcdLabeling"
...
class(labeling_left) <- "vcdLabeling"
...
class(labeling_cboxed) <- "vcdLabeling"
...
class(labeling_lboxed) <- "vcdLabeling"
